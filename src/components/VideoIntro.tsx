      ...
      <div className="relative w-full h-full">
        ...
        {needsUnmute && isVisible && (
          <button
            ...
            className="absolute bottom-6 right-6 z-[110] bg-white/90 text-black border border-black/20 rounded-full px-4 py-2 hover:scale-105 transition-transform shadow-lg"
        ...
        {isVisible && (
          <button
            ...
            className="absolute top-6 right-6 z-[110] bg-white/90 text-black border border-black/20 rounded-full px-4 py-2 hover:scale-105 transition-transform shadow-lg"
