    ...
    <footer className="w-full py-8 px-4 md:px-12 bg-background/80 backdrop-blur-sm border-t border-border/20">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-muted-foreground leading-relaxed" style={{ fontSize: '8pt' }}>
          This document is intended for informational and cultural purposes only and does not constitute a legally binding agreement or investment solicitation. Salune is an experimental platform at the intersection of art, technology, and decentralized systems. Tokens or mints associated with Salune projects represent creative participation and process documentation, not ownership of financial assets or securities.
        </p>
