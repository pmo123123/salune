  ...
  return <div className="min-h-screen relative">
      ...
      <main className="pt-24 pb-16 relative z-10">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          {/* Slogan */}
          <div className="w-full max-w-6xl mx-auto mb-16 -mt-[75px] px-4" style={{ textAlign: 'center' }}>
          ...
          <div className="w-full mb-16">
            <img src={heroBackground} alt="Creative workspace" className="w-full h-[400px] md:h-[500px] object-cover rounded-lg" />
          </div>

          {/* Title */}
          <h1 className="text-3xl md:text-5xl font-bold text-center text-foreground mb-16 max-w-4xl mx-auto font-grotesk">
            Salune: The New Frontier of Creative Infrastructure
          </h1>

          {/* Text Content - Magazine Style */}
          <div className="max-w-5xl mx-auto space-y-16 text-foreground font-grotesk">
            ...
            <section className="space-y-6">
              <h2 className="text-2xl md:text-3xl font-semibold">Salune adopts this infrastructural mindset and applies it to the scale of individual producers.</h2>
              <p className="text-lg md:text-xl leading-relaxed">
