      ...
      >
        <div className="relative min-h-screen px-4 py-8 md:py-12">
          ...
          <div id="gallery-section" className="relative z-10 max-w-[1400px] mx-auto">
            ...
            {/* Projects Grid */}
            <div className="bg-white/70 border border-black/20 rounded-lg p-6 md:p-8 -mt-[75px] mx-12 md:mx-16">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8">
                {projects.map((project, idx) => (
                  ...
                  >
                    ...
                    <Link to={`/project/${project.id}`} className="block mx-auto max-w-[calc(100%-50px)]">
                    ...
                    <div className="flex justify-between text-sm text-black px-4">
